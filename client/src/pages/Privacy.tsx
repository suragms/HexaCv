...
export default function Privacy() {
  return (
    <LegalPageLayout title="Privacy Policy">
      <section>
        <h2 className="font-display text-lg font-semibold text-foreground">1. Resume content as personal data</h2>
        <LegalPlaceholder>
          Name, contact details, work history, and other resume fields are personal data and how HexaCv stores them.
        </LegalPlaceholder>
      </section>
      <section>
        <h2 className="font-display text-lg font-semibold text-foreground">2. Guest data retention</h2>
        <LegalPlaceholder>
          How long guest-session data is kept and what happens on signup conversion.
        </LegalPlaceholder>
      </section>
      <section>
        <h2 className="font-display text-lg font-semibold text-foreground">3. Sharing with AI providers</h2>
        <LegalPlaceholder>
      ...
      <section id="evaluation-opt-out">
        <h2 className="font-display text-lg font-semibold text-foreground">4. Evaluation-dataset opt-out</h2>
        <LegalPlaceholder>
      ...
      <section id="cookies">
        <h2 className="font-display text-lg font-semibold text-foreground">5. Cookies and session</h2>
        <LegalPlaceholder>
