> **Historical / superseded.** Prefer `docs/architecture/ARCHITECTURE.md`,
> `docs/ops/BUILD_AND_DEPLOYMENT.md`, and `docs/design/DESIGN_AND_PROMPTS.md`
> for current guidance. Kept for reference only.
...
â”‚   â””â”€â”€ public/            # Static assets & PWA config
...
â””â”€â”€ references/            # Integration guides
```
...
3. **Custom Domain** - Configure domain in Settings â†’ Domains
...
**Scratch Tab:**
- Step-by-step form (Header â†’ Summary â†’ Skills â†’ Experience â†’ Projects â†’ Education â†’ Certifications)
...
**Â© 2026 HexaStack Solutions. All rights reserved.**
